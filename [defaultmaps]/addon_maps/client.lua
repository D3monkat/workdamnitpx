...
AddEventHandler('playerSpawned', function()
    local interiorHash = GetInteriorAtCoords(803.34, -88.47, 74.92)
...
--druglabs
AddEventHandler('playerSpawned', function()
    local interiorHash = GetInteriorAtCoords(2540.71, 4119.1, 31.47) --Meth
    RefreshInterior(interiorHash)
    EnableInteriorProp(interiorHash, "light_stock")
    ...
    local interiorHash = GetInteriorAtCoords(2862.7, 4457.0, 41.32) --Opium
    RefreshInterior(interiorHash)
