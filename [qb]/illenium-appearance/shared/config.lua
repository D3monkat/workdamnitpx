...
Config.Stores = {
    ...
    { -- air port
        type = "clothing",
        coords = vector4(-1038.64, -2781.9, 21.34, 99.7),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1030.6806640625, -2773.9428710938, 21.34),
            vector3(-1035.3896484375, -2769.4753417968, 21.34),
            vector3(-1037.3837890625, -2768.361328125, 21.34),
            vector3(-1047.4205322266, -2786.1594238282, 21.34),
            vector3(-1039.0163574218, -2790.4099121094, 21.34)
        }
    },
    {-- airport
        type = "barber",
        coords = vector4(-1045.48, -2792.79, 21.34, 334.65),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1047.67, -2788.46, 21.34),
            vector3(-1039.76, -2793.44, 21.34),
            vector3(-1042.03, -2797.46, 21.34),
            vector3(-1051.03, -2792.48, 21.34)
        }
    },
    {
        type = "barber",
