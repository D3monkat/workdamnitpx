svConfig.translations = {
    ...
    TEXT_CHAT_NOTIFICATION_NOT_IDENTIFIER = "You haven't identified yourself in the drifting tablet!",
    ...
    TEXT_CHAT_NOTIFICATION_DISQUALIFIED = 'Your result did not count because you used an inappropriate trajectory.',
    ...
    NOTIFICATION_DISCORD_COMPETITION_DESCRIPTION = 'Drifting system',
