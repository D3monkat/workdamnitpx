...
Config = {
    ...
    Position = 'bottom', -- If using ox_lib for Notifications only! 'top', 'top-right', 'top-left', 'bottom', 'bottom-right', 'bottom-left', 'center-right' or 'center-left'
    ...
    WeaponBench     = ``, -- Can Change
    AttachmentBench = ``, -- Can Change
    AmmoBench       = ``, -- Can Change
