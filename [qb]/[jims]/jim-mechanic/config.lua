Config = {
	...
	Previews = {
		oldOxLibMenu = false,		-- Enable this to use default context menu for previews when using ox_lib
	...
	Odometer = {
		...
		odoCustomisation = {
			...
			screenPosition = { top = 95, left = 20 },				-- where on the screen it will appear (percentages) default bottom right
	...
	ManualRepairs = { -- Player vehicle repair config
		ManualRepairCost = math.random(5000,40000), 	-- Set this to a high amount to get people to talk to mechanics rather than use automated systems
	...
	antiLag = {
		...
		maxAudio = 0.2,				-- This is adjusted by distance to enchance the effect, this is the max volume
	},
	...
	NOS = { -- NOS STUF
		...
		NitrousUseRate = 0.8, 		-- How fast the nitrous drains (halved for level1, doubled for level3)

		NitrousCoolDown = 120, 		-- 7 Seconds for nitrous cooldown, set to 0 to disable
