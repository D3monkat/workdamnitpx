...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("https://pug-fishing/TresureClick");
...
Thermite.Failed = function() {
    if (active) $.post("https://pug-fishing/TresureFailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("https://pug-fishing/TresureSuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('https://pug-fishing/CloseTresure');
}