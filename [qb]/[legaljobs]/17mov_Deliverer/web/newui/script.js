...
window.addEventListener('message', function (event) {
    ...
    if (action == "addNewMember") {
        ...
        $("#counter").fadeOut(250)
        $(".header .bgText").text("DELIVER LOBBY")
        $(".header .text").text("DELIVERER LOBBY")
        $("#inviteScreen").fadeOut(250)
        $("#warningScreen").fadeOut(250)
        $("#tutorialScreen").fadeOut(250)
        ...
        $("#counterValue").text(`Delivered Parcels: 0`)
        $("#counter").fadeIn(250)
        counterActive = true
        ...
        $("#counterValue").text(`Delivered Parcels: ${event.data.value.toString()}`)
