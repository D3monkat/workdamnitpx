...
local qbJobAreaControllers = { -- QB jobs that can access /hall is specific areas.
    ['shopsunsetmotors'] = { -- Remove this to disable it, or add more entries as you wish.
        {'shopsunsetmotors', 0}, -- QB "unicorn" job with 2 grade level can access "vanilla_unicorn" area.
        'shopsunsetmotors' -- QB "dj" job can access /hall in "vanilla_unicorn" regardless of grade level.
    },
